...
@WebServiceClient(name = "CustomerWS",
                  wsdlLocation = "file:/Users/mohamedelhakki/IdeaProjects/account-data-service/src/main/resources/CustomerService.wsdl",
                  targetNamespace = "http://web.customerdataservice.elhakki.net/")
public class CustomerWS extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://web.customerdataservice.elhakki.net/", "CustomerWS");
    public final static QName CustomerSoapServicePort = new QName("http://web.customerdataservice.elhakki.net/", "CustomerSoapServicePort");
    static {
        URL url = null;
        try {
            url = new URL("file:/Users/mohamedelhakki/IdeaProjects/account-data-service/src/main/resources/CustomerService.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(CustomerWS.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/Users/mohamedelhakki/IdeaProjects/account-data-service/src/main/resources/CustomerService.wsdl");
        }
        WSDL_LOCATION = url;
    }
