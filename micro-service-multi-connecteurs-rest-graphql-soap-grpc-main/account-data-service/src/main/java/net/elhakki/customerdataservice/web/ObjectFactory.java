 ...
 * generated in the net.elhakki.customerdataservice.web package. 
...
public class ObjectFactory {
    ...
    private final static QName _CustomerById_QNAME = new QName("http://web.customerdataservice.elhakki.net/", "customerById");
    private final static QName _CustomerByIdResponse_QNAME = new QName("http://web.customerdataservice.elhakki.net/", "customerByIdResponse");
    private final static QName _CustomerList_QNAME = new QName("http://web.customerdataservice.elhakki.net/", "customerList");
    private final static QName _CustomerListResponse_QNAME = new QName("http://web.customerdataservice.elhakki.net/", "customerListResponse");
    private final static QName _SaveCustomer_QNAME = new QName("http://web.customerdataservice.elhakki.net/", "saveCustomer");
    private final static QName _SaveCustomerResponse_QNAME = new QName("http://web.customerdataservice.elhakki.net/", "saveCustomerResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: net.elhakki.customerdataservice.web
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://web.customerdataservice.elhakki.net/", name = "customerById")
     ...
     */
    @XmlElementDecl(namespace = "http://web.customerdataservice.elhakki.net/", name = "customerByIdResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://web.customerdataservice.elhakki.net/", name = "customerList")
     ...
     */
    @XmlElementDecl(namespace = "http://web.customerdataservice.elhakki.net/", name = "customerListResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://web.customerdataservice.elhakki.net/", name = "saveCustomer")
     ...
     */
    @XmlElementDecl(namespace = "http://web.customerdataservice.elhakki.net/", name = "saveCustomerResponse")
