package net.elhakki.accountdataservice.web;

import net.devh.boot.grpc.client.inject.GrpcClient;
import net.elhakki.accountdataservice.feign.CustomerRestClient;
import net.elhakki.accountdataservice.mapper.CustomerMapper;
...
public class AccountRestController {
    ...
    public List<Customer> soapCustomers(){
        List<net.elhakki.customerdataservice.web.Customer> soapCustomers = customerSoapService.customerList();
    ...
    public Customer customerByIdSoap(@PathVariable Long id){
        net.elhakki.customerdataservice.web.Customer soapCustomer = customerSoapService.customerById(id);
